...
> 2. Un health check con curl al localhost:3000 para confirmar que el backend responde
...
| `DATABASE_URL` | Cadena de conexión PostgreSQL de producción | `postgresql://user:pass@host:5432/db` |
